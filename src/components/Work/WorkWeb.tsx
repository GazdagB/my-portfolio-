const WorkWeb = ({title = "This Is A Placeholder Title",type = "Random type"}) => {
  return (
    <div className="max-w-[300px]">
        ...
        <div className="mb-3 bg-primary px-3 rounded-full w-fit">{type}</div>
        ...
        <div className="flex items-center gap-5">
            <button className="cursor-pointer text-white bg-charcoal px-5 py-1 rounded-md">Live Site</button>
